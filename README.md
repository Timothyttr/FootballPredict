...
- HTHG = Half Time Home Team Goals - relationship to full time goals
- HTAG = Half Time Away Team Goals - relationship to full time goals
- HTR = Half Time Result (H=Home Win, D=Draw, A=Away Win)

Match Statistics (where available)
- Attendance = Crowd Attendance - REMOVE - Maybe
- Referee = Match Referee
- HS = Home Team Shots
- AS = Away Team Shots
- HST = Home Team Shots on Target
- AST = Away Team Shots on Target
- HHW = Home Team Hit Woodwork - REMOVE 
- AHW = Away Team Hit Woodwork - REMOVE
...
- HR = Home Team Red Cards - REMOVE - already represented by booking score
- AR = Away Team Red Cards - REMOVE - already represented by booking score
